...
3. [Fearless Tinkering with Haskell](./fearless-tinkering-haskell)
4. [Fearless. Functional. Future.](./fearless-functional-future)
...
That's all for now! The [next part](./fearless-tinkering-haskell) of this article will continue with more examples of functional programming in practice. Additionally, the follow-up will discuss how exploiting one's underlying algebra allows any technology to create fearless experiences. Lastly, the final part will introduce several promising functional technologies on the horizon and speculate about their fearless futures.
