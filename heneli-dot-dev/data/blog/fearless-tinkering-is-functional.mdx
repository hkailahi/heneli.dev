...
That's all for now. The second half of this article will continue with more examples of functional technologies in practice. Additionally, the follow-up will discuss how, beyond the functional paradigm, fearless experiences can be created by any technology that exploits its underlying algebra. Finally, the article will finish by introducing new and exciting functional technologies on the horizon and speculate about their fearless futures.
