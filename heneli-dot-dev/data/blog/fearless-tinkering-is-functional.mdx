...
Rather than storing components by the hash of their build plan, Nix support for storing components by the hash of their build outputs is progressing. This property is commonly referred to as being **content-addressable**, and would reduce recompilation via [_early cutoff_](https://www.microsoft.com/en-us/research/uploads/prod/2018/03/build-systems.pdf). For obvious reasons, bit-for-bit reproducibility is important for content-addressable builds.
