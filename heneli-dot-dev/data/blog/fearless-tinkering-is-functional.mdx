...
<details>
  ...
  In addition, packages can be audited by generating SBOMs with [`sbomnix`](https://github.com/tiiuae/sbomnix):
  ```bash
...
That's all for now! The second half of this article will continue with more examples of functional programming in practice. Additionally, the follow-up will discuss how, by exploiting their underlying algebra, any technology can create fearless experiences. Finally, the article will finish by introducing promising functional technologies on the horizon and speculate about their fearless futures.
