...
<div className="overflow-x-auto">
  ...
  | nondeterminism | consistency | ambiguous requirements | hardware faults |
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          log4Info(msg):
              ...
              return “info: ” + msg
          ```
          <caption className="flex justify-center prose prose-sm dark:prose-dark">Side Effect</caption>
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          2.25
          ```
          <caption className="flex justify-center prose prose-sm dark:prose-dark">Left-to-right is different from Right-to-left</caption>
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          *** error!
          ```
          <caption className="flex justify-center prose prose-sm dark:prose-dark">`square` does not accepts nulls</caption>
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          *** error!
          ```
          <caption className="flex justify-center prose prose-sm dark:prose-dark">Non-exhaustive handling of inputs</caption>
        </td>
...
[^6]:
    I have cowardly deferred to others the task of formally defining “functional programming.” This is because FP is a vibe.
