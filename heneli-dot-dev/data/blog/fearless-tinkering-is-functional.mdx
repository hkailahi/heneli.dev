...
Meanwhile, Nix has developed to fill these gaps. Nix can fit neatly within existing infrastructure, letting engineers recover [compositionality](https://nixos.org/manual/nix/stable/language/index.html) and [reproducibility](https://r13y.com/) while using [IaC](https://nix.dev/tutorials/nixos/build-and-deploy/deploying-nixos-using-terraform), [containers](https://floxdev.com/blog/flox-and-containers), and other solutions. Nix can also subsume various existing tools with things like NixOS, Home-Manager, `deploy-rs`, and others. This versatility allows Nix to be introduced piecemeal into projects and organizations.
...
That's all for now! The second half of this article will continue with more examples of functional programming in practice. Additionally, the follow-up will discuss how, by exploiting their underlying algebra, any technology can create fearless experiences. Lastly, the article will introduce several promising functional technologies on the horizon and speculate about their fearless futures.
...
[^3]:
    In the draft versions of this blogpost, I said that functional programming had best-in-class learnability instead of discoverability and experimentation. I suspect that many of my peers would find this initial claim absurd. I'll acknowledge that countless have bounced off of functional languages and that huge efforts by functional advocates have been motivated directly because of these approachability issues.
...
[^4]:
    The definition of accidental complexity in 'Out of the Tar Pit' is more specific, but can be treated more broadly as meaning self-inflicted or avoidable complexity in this article.
